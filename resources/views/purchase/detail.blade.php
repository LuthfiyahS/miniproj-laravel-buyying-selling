...
@section('content')
    <div class="page-header">
        <div class="page-title">
            ...
            <h6>View Detail Purchase</h6>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="card-sales-split">
                <h5>Purchase Detail #{{$data->number}} </h5>
                <form action="{{route('purchase.destroy',$data->id)}}" method="post">
                    ...
                    <ul>
                        <li>
                            ...
                            <a href="{{route('purchase.edit',$data->id)}}" class="btn bg-transparant"><img src="{{ asset('../theme/assets/img/icons/edit.svg') }}" alt="img"></a>
                            <button type="submit" class="btn bg-transparant"><img src="{{ asset('../theme/assets/img/icons/delete-2.svg') }}" alt="img"></button>
                            @endif
                            <a class="btn bg-transparant" href="/purchase-invoice/{{ $data->id }}" target="_blank"><img src="{{ asset('theme/assets/img/icons/pdf.svg') }}" alt="img"></a>
                        </li>
                    </ul>
                </form>
