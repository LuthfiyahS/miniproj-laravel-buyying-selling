...
<head>
    ...
    <title>Login - BnS App</title>

    <link rel="shortcut icon" type="image/x-icon" href="{{asset('theme/assets/img/logonyn.png')}}">
    ...
    <div class="main-wrapper">
        <div class="account-content">
            <div class="login-wrapper">
                <div class="login-content">
                    <div class="login-userset">
                        <div class="login-logo">
                            <img src="{{asset('theme/assets/img/logo.png')}}" alt="img">
                        </div>
                    ...
                    <form action="/login" method="POST">
                        ...
                        <div class="form-login">
                            ...
                            <div class="form-addons">
                                ...
                                <img src="{{asset('theme/assets/img/icons/mail.svg')}}" alt="img">
                            </div>
                        </div>
                        <div class="form-login">
                            ...
                            <ul>
                                <li>
                                    <a href="javascript:void(0);">
                                        <img src="{{asset('theme/assets/img/icons/google.png')}}" class="me-2" alt="google">
                                        Sign Up using Google
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:void(0);">
                                        <img src="{{asset('theme/assets/img/icons/facebook.png')}}" class="me-2" alt="google">
                ...
                <div class="login-img">
                    <img src="{{asset('theme/assets/img/login.jpg')}}" alt="img">
                </div>
            </div>
        </div>
    </div>
