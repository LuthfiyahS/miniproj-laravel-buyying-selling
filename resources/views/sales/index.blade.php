...
@section('content')
    <div class="page-header">
        ...
        <div class="page-btn">
            ...
            <a href="{{ route('sales.create') }}" class="btn btn-added "><img
                    src="{{ 'theme/assets/img/icons/plus.svg' }}" alt="img" class="me-2" />Add Sales</a>
            @endif
        </div>
    </div>
    <div class="row">
            ...
            <div class="table-top">
                ...
                <div class="wordset">
                    <ul>
                        ...
                        <li>
                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="excel" href="/sales-export/excel"><img
                                    src="{{ asset('theme/assets/img/icons/excel.svg') }}" alt="img"></a>
                        </li>
                        <li>
                            <a data-bs-toggle="tooltip" data-bs-placement="top" title="print"  onClick="this.href='/sales-laporan/'+ document.getElementById('start').value + '/' + document.getElementById('end').value" target="_blank"><img src="{{ asset('theme/assets/img/icons/pdf.svg') }}" alt="img"></a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center">
                                <a href="{{route('sales.show',$x->id)}}" class="text-primary">
                                    {{ $x->number }}</a>
                            </td>
